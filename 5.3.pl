...
sub printf_tables {
    ...
    my $y = 0; # индекс для проверки цикла для создания ширины таблицы

    # Хорошо, если вводимое число десятикратное, а если 11, 7 или 13?
    # ниже блок проверяет на чётность и округляет выше, т.е. 11 -> 20, 7 -> 10 etc.
