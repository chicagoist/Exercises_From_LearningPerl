...
# Если вы использовали в предыдущем упражнении 13.2.pl дескриптор каталога,
# перепишите программу с использованием глоба.
# Если программа была написана для глоба, перепишите ее для дескриптора каталога.
