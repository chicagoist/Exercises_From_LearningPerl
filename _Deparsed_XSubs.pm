...
sub IPV6_ADDR_6BONE;
sub IPV6_ADDR_6TO4;
sub IPV6_ADDR_6TO4_MICROSOFT;
sub IPV6_ADDR_AGU;
sub IPV6_ADDR_ANY;
sub IPV6_ADDR_ANYCAST;
sub IPV6_ADDR_COMPATv4;
sub IPV6_ADDR_ISATAP;
sub IPV6_ADDR_LINKLOCAL;
sub IPV6_ADDR_LOOPBACK;
sub IPV6_ADDR_MAPPED;
sub IPV6_ADDR_MULTICAST;
sub IPV6_ADDR_NON_ROUTE_DOC;
sub IPV6_ADDR_ORCHID;
sub IPV6_ADDR_PRODUCTIVE;
sub IPV6_ADDR_RESERVED;
sub IPV6_ADDR_SCOPE_MASK;
sub IPV6_ADDR_SITELOCAL;
sub IPV6_ADDR_SOLICITED_NODE;
sub IPV6_ADDR_TEREDO;
sub IPV6_ADDR_ULUA;
sub IPV6_ADDR_UNICAST;
sub IPV6_ADDR_UNSPECIFIED;
sub LINUX_COMPATv4;
sub PF_APPLETALK;
sub PF_ASH;
sub PF_AX25;
...
sub PF_X25;
sub RFC2373_GLOBAL;
sub RFC2373_LINKLOCAL;
sub RFC2373_NODELOCAL;
sub RFC2373_ORGLOCAL;
sub RFC2373_SITELOCAL;
sub _NI_AF_TEST;
sub __developer;
sub _lx_scope;
sub _lx_types;
